...
namespace Magic.IO
{
    ...
    public abstract class EndianBitConverter
    {
        ...
        {
            // This always assumes four parts, each in their own endianness,
        ...
        /// <summary>
        /// Returns the specified 32-bit integer value as an array of bytes.
        /// </summary>
        /// <param name="value">The number to convert.</param>
        /// <returns>An array of bytes with length 1-5.</returns>
